...
Throughout this perspective, we highlighted various challenges in applying ML to rare disease data as well as examples of approaches that address these challenges.
...
Beyond rare disease, the approaches described here may also benefit other areas where a paucity of data makes analysis difficult, such as precision medicine applications developing customized treatment plans for an individual patient's unique genotype and phenotype.
It should be noted that the line between classical statistical methods and machine learning methods is fuzzy.
Multiple statistical techniques that were considered to be out of scope of this article (e.g. hierarchical models, Bayesian frameworks, association tests) [@pmid:26924528; @pmid:21737059; @pmid:25502226; @pmid:28669401], may have substantial potential to  enhance the accuracy and generalizability of the models they build, and should be considered in the rare disease study design process.
...
In particular, the following two areas are important for the field to explore to increase the utility of machine learning in rare disease.
...
An anecdotal example: conversations with a rare disease clinician revealed that samples in a particular tumor dataset were collected using vastly different surgical techniques (laser ablation and excision vs standard excision).
...
Adoption of these approaches into biomedical ML is quickly becoming necessary as ML approaches become mainstream in research and clinical settings.
