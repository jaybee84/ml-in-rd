...
Such instances underline the fact that continuous collaboration with domain experts and the sharing of well-annotated data is needed to generate robust datasets in the future. [TODO: Is this sufficiently different from the combining datasets section now?]
