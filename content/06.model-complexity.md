...
In this study, adding LASSO regularization helped reduce the number of common variants selected to be included as features in the final analysis facilitating generation of a simpler model while reducing error in the association between common and rare variants with a specific trait. 
