...
There is high class imbalance due to small number of samples for specific classes, abundant label-noise due to lack of understanding of the disease, and in many cases sparsity in data.
...
Techniques like resampling (with or without replacement) and combining various ML methods together (ensemble learning) can help achieve stability in predictions (Figure[@fig:2]A-B). 
...
Resampling with replacement (bootstrapping) helps estimate consensus or confidence intervals for model predictions by generating random combinations of data points to maximise information from datasets of limited size.
It is also commonly used to find robust models when multiple models are combined into an ensemble ([@doi:10.1080/01621459.1997.10474007; @https://doi.org/10.1023/A:1010933404324; @doi:10.1198/0003130043277; @doi:10/c8xpqz; @doi:10.1016/j.neucom.2004.11.017; @doi:10.1002/sim.4780111607]).
