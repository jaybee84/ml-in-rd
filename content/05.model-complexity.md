...
For example, of the various regularization methods(ridge regression, LASSO regression, and elastic-net regression), ridge regression has been used to combine rare variants into a single score to increase the signal of these variants [@doi:10.1371/journal.pone.0044173], while LASSO has been implemented along with group penalties to identify gene variants [@doi:10.1038/nrg2867; @doi:10.1093/bioinformatics/btq448]. 
...
Of the various regularization methods(ridge regression, LASSO regression, and elastic-net regression), elastic-net regression (a combination of LASSO and ridge) [@doi:10.1111/j.1467-9868.2005.00503.x] selects the most useful features, especially in presence of a large number of correlated features.
