...
First, assuming that all categories in a dataset have comparable variance, the dataset contains an equal number of samples for all categories (no “class imbalance”).
...
In the context of rare immune cell signature discovery, where a few genes or features are expected to distinguish between immune cell types, elastic-net regression was able to exclude groups of uninformative genes by reducing their coefficients to zero. [@doi:10.1186/s12859-019-2994-z, @https://doi.org/10.1111/j.1467-9868.2005.00503.x]
