...
We highlight applications of multitask or few-shot learning in the drug discovery space, in addition to rare disease or condition research, to illustrate key takeaways.
...
In predicting phenotypes from EHR data, Ding et al. demonstrated that multitask neural nets outperformed single-task networks for predicting complex rare phenotypes but not common phenotypes [@arxiv:1808.03331].
