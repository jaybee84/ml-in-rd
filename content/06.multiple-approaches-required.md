...
The representations or _encodings_ learned by the VAE were then _transferred_ to the small _in-vitro_ dataset reducing it's number of features from thousands to eight, and increasing the performance of the final LASSO linear regression model.
