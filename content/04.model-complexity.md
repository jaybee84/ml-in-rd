...
Rare disease datasets not only present few data points but the data points also come with high label-uncertainty thus forming silver standard datasets.
Implementing machine learning on such data can lead to unstable predictions. 
