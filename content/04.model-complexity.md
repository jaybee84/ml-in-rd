...
Ridge regression aims to minimize the magnitude of the features, but cannot completely remove unimportant features and thus is not be ideal for reducing the feature space. 
...
Elastic-Net regression is a combination of LASSO and ridge regression[@doi:10.1111/j.1467-9868.2005.00503.x], and helps to select most useful features, specially where there are a lot of correlated features. 
