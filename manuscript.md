...
<small><em>
This manuscript
([permalink](https://jaybee84.github.io/ml-in-rd/v/2d092e017505255e6376bdf32874798fba86a336/))
was automatically generated
from [jaybee84/ml-in-rd@2d092e0](https://github.com/jaybee84/ml-in-rd/tree/2d092e017505255e6376bdf32874798fba86a336)
on February 2, 2021.
</em></small>
...
ML based methods benefit from using large and high dimensional datasets, but analyzing high dimensional data from rare diseases datasets that typically contain 20 to 99 samples is challenging [@https://www.fda.gov/media/99546/download; @doi:10.1186/s13023-020-01424-6].
The small datasets lead to the lack of statistical power and magnify the susceptibility of ML methods to misinterpretation and unstable performance.
...
Thus, specialized computational methods that can learn patterns from small datasets but can also be generalized to newly acquired data are required for rare disease applications [@doi:10.1016/j.ebiom.2019.08.027]. 
In this perspective, we first highlight few ML approaches that address or better tolerate the limitations of rare disease data, and then discuss the future of ML applications in rare disease.
...
Regular ensemble learning has shown limited success in rare disease datasets where the label-uncertainty can be high. 
...
Simplification of models by making the feature space proportionate with the sample space can be achieved through regularization. (Figure[@fig:2]C)
...
PLIER used constraints (regularization) that aligned learned _latent variables_ with a small number of input gene sets making it suitable for biological discovery or description of rare disease data. 
